...
export const routes: Route[] = [
    { id: 1, routeName: 'Home', routePath: '/home', testid: 'nav-link' },
    { id: 2, routeName: 'Products', routePath: '/', testid: 'nav-link' },
    { id: 3, routeName: 'About', routePath: '/about', testid: 'nav-link' },
    { id: 4, routeName: 'Contact', routePath: '/contact', testid: 'nav-link' },
];
